...
class RiskAssesmentPage(MDScreen):
    ...
    def on_pre_enter(self):
        ...
        # self.ids['air_pollution_pct'].secondary_text=str(self.parent.ids['AirPollutionPage'].air_pollution_pct)+'% Complete'
...
class SociodemographicPage(MDScreen):
    ...
    def on_pre_leave(self):
        ...
        print (pct)
        self.parent.ids['RiskAssesmentPage'].ids['demographics_label'].secondary_text=pct_txt
...
class WindowManager(ScreenManager):
    ...
    def init(self,dt):
        self.current='AirPollutionScorePage'
